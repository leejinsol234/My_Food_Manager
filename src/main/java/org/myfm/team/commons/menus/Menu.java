package org.myfm.team.commons.menus;
...
public class Menu {
    ...
    public static List<MenuDetail> gets(String code) {
        ...
        } else if (code.equals("survey")) { // 설문지 관리
            menus.add(new MenuDetail("survey", "설문지 목록", "/admin/survey"));
            menus.add(new MenuDetail("add", "설문지 등록", "/admin/survey/add"));
        }
